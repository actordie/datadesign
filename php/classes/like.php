...
class Tweet implements \JsonSerializable {
	 ...
	 * @throws \TypeError when variables are not the correct data type
	 **/
	public static function getTweetsByTweetProfileId(\PDO $pdo, int $tweetProfileId) : \SplFixedArray {
	 ...
	 * @throws \TypeError when variables are not the correct data type
	 **/
	public static function getTweetsByTweetContent(\PDO $pdo, string $tweetContent) : \SplFixedArray {
